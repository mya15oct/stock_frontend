                ...
                <div className="absolute top-full left-0 mt-1 w-64 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <div className="py-2">
                    ...
                    >
                      ...
                      <div>
                        <div className="font-medium">Dividend Calendar</div>
                        <div className="text-sm text-gray-500">View upcoming dividend payments</div>
                      </div>
                    </Link>
                    <Link
                    ...
                    >
                      <span className="text-lg">📅</span>
                      <div>
                        <div className="font-medium">Ex-Dividend Calendar</div>
                        <div className="text-sm text-gray-500">Track ex-dividend dates</div>
                      </div>
                    </Link>
                  </div>
                </div>
