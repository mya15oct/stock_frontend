  ...
  const faqData = [
    {
      ...
      answer: "Apple Inc belongs to the Information Technology sector and operates in the Consumer Electronics industry."
    },
    {
      question: "What is Apple Inc (AAPL) current stock price?",
      answer: "As of the latest data, Apple Inc stock price is $245.27, with a previous close of $254.04. Apple Inc lost -$8.77 in the last trading session, representing a -3.45% loss."
    },
    {
    ...
    },
    {
      ...
      answer: "Apple Inc current P/E ratio is 37.28, with a forward P/E of 30.87."
    },
    {
      question: "What is Apple Inc (AAPL) EBITDA?",
      answer: "Apple Inc EBITDA (Earnings Before Interest, Taxes, Depreciation, and Amortization) is 31.03 billion."
    },
    {
      question: "Does Apple Inc (AAPL) pay dividends?",
      answer: "Yes, Apple Inc pays quarterly dividends with an annualized yield of 0.42% and an estimated annual payout of $1.04 per share."
    },
    {
    ...
    {
      question: "How did Apple Inc (AAPL) perform in its most recent earnings report?",
      answer: "In the last report (June 30, 2025), Apple Inc posted an EPS surprise of 11.35% and a revenue surprise of 5.47%."
    },
    {
      question: "When is Apple Inc (AAPL) next earnings report?",
      answer: "Apple Inc is expected to release its next earnings report on September 30, 2025."
    },
    {
      question: "What is Apple Inc (AAPL) beta (volatility) score?",
      answer: "Apple Inc has a beta of 1.165, meaning its volatility is roughly in line with the market."
    }
  ]
      ...
      <div className="container mx-auto px-6 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <Card className="bg-white">
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-2">
                  <h4 className="font-semibold text-gray-900 text-base">Benchmarks</h4>
            ...
            <Card className="bg-white flex-1">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2 text-sm">
                  <span className="text-gray-500 font-medium">Oct 11, 24 - Oct 11, 25</span>
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span className="text-green-600 font-semibold">+$17.72 (▲ 7.79%)</span>
                </div>
              </div>
              ...
              <div className="relative flex-1 min-h-[400px] bg-white">
                ...
                <svg className="w-full h-full" viewBox="0 0 1000 400" role="img" aria-label="Price history Nov '24 – Oct '25">
                  <defs>
                  ...
                  {/* Y-axis labels */}
                  <g fontFamily="system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial" fontSize="12" fill="#6B7280" textAnchor="end">
                    <text x="60" y="343">160</text>
                    <text x="60" y="291.33">180</text>
                    <text x="60" y="239.67">200</text>
                    <text x="60" y="188">220</text>
                    <text x="60" y="136.33">240</text>
                    <text x="60" y="84.67">260</text>
                    <text x="60" y="33">280</text>
                  </g>

                  {/* X-axis labels */}
                  <g fontFamily="system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial" fontSize="12" fill="#6B7280" textAnchor="middle">
                    <text x="70" y="370">Nov '24</text>
                    <text x="150.91" y="370">Dec '24</text>
                    <text x="231.82" y="370">2025</text>
                    <text x="312.73" y="370">Feb '25</text>
                    <text x="393.64" y="370">Mar '25</text>
                    <text x="474.55" y="370">Apr '25</text>
                    <text x="555.45" y="370">May '25</text>
                    <text x="636.36" y="370">Jun '25</text>
                    <text x="717.27" y="370">Jul '25</text>
                    <text x="798.18" y="370">Aug '25</text>
                    <text x="879.09" y="370">Sep '25</text>
                    <text x="960" y="370">Oct '25</text>
                  </g>
                  ...
                  {/* Current price dot */}
                  <circle cx="960" cy="107.5" r="4.5" fill="#3B82F6" stroke="#FFFFFF" strokeWidth="2" />

                  {/* Max line + label - Full width */}
                  <line x1="70" x2="960" y1="86.8" y2="86.8" stroke="#9CA3AF" strokeDasharray="4,2" strokeWidth="1" />
                  <text x="960" y="82" textAnchor="end" fill="#6B7280" fontSize="12" fontFamily="system-ui">max: $259.02</text>

                  {/* Min line + label - Full width */}
                  <line x1="70" x2="960" y1="309" y2="309" stroke="#9CA3AF" strokeDasharray="4,2" strokeWidth="1" />
                  <text x="960" y="322" textAnchor="end" fill="#6B7280" fontSize="12" fontFamily="system-ui">min: $172.42</text>
                </svg>
              </div>
            </Card>
          </div>
          ...
          <div className="lg:col-span-1 flex flex-col gap-4">
            {/* Estimate */}
            <Card className="bg-white">
              <h4 className="font-semibold text-gray-900 text-base mb-4">Estimate</h4>
            ...
            {/* Growth */}
            <Card className="bg-white">
              <h4 className="font-semibold text-gray-900 text-base mb-4">Growth</h4>
              <div className="space-y-3 text-sm">
                <div className="flex justify-between">
            ...
            {/* Forecast */}
            <Card className="bg-white">
              <h4 className="font-semibold text-gray-900 text-base mb-4">Forecast</h4>
              <div className="space-y-3 text-sm">
                <div className="flex justify-between">
            ...
            {/* Dividends */}
            <Card className="bg-white">
              <h4 className="font-semibold text-gray-900 text-base mb-4">Dividends</h4>
              <div className="space-y-3 text-sm">
                <div className="flex justify-between">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6 pb-6 border-b border-gray-200">
          ...
          <div>
            ...
            <div className="text-base font-semibold text-gray-900">United States of America</div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="text-base font-semibold text-gray-900">NASDAQ</div>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-600">Industry</label>
            <div className="text-base font-semibold text-gray-900">Information Technology</div>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-600">Sector</label>
            <div className="text-base font-semibold text-gray-900">Technology Hardware & Equipment</div>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-600">Market cap</label>
            <div className="text-base font-semibold text-gray-900">$3.77T</div>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-600">Employees</label>
            <div className="text-base font-semibold text-gray-900">161,000</div>
          </div>
        </div>
